...
$app->get('/admin/login', function() {
	...
	//Header e Footer do Pageadmin é toda a estrutura do AdminLTE em si.
	$page = new PageAdmin([
		"header" => false,
		"footer" => false
	]);
...
$app->post("/admin/forgot/reset", function(){
	...
	$user->setPassword($password); //password é nome do campo
...
$app->post("/admin/categories/:idcategory", function($idcategory){
	...
	$category->setData($_POST); //Inputs mesmo nome do banco
